...
TEST_F(HashSetTest, BasicTest) {
    ...
    DLinkedElement *current_element = hashset_first(set);
    while (current_element != nullptr) {
        void *value = current_element->value;
        current_element = hashset_next(current_element);
...
TEST_F(HashSetTest, UnionTest) {
    ...
    hashset_create(set1, 16, hash_block, cmp_block, free);
    chunk1 = (Chunk *) malloc(sizeof(Chunk));
    chunk2 = (Chunk *) malloc(sizeof(Chunk));
    chunk1->data = 1;
    chunk2->data = 2;
...
TEST_F(HashSetTest, HashSetDifferenceTest) {
    ...
    Chunk *chunk1, *chunk2;
    Block *b1, *b2, *b3, *b4, *b5, *b2_1, *b2_2;
    chunk1 = (Chunk *) malloc(sizeof(Chunk));
    chunk2 = (Chunk *) malloc(sizeof(Chunk));
    chunk1->data = 1;
    chunk2->data = 2;
    b1 = (Block *) malloc(sizeof(Block));
    b2_1 = (Block *) malloc(sizeof(Block));
    b2 = (Block *) malloc(sizeof(Block));
    b2_2 = (Block *) malloc(sizeof(Block));
    b3 = (Block *) malloc(sizeof(Block));
    b4 = (Block *) malloc(sizeof(Block));
    ...
    hashset_create(left, 16, hash_block, cmp_block, free);
    hashset_create(right, 16, hash_block, cmp_block, free);
    ...
    memcpy(b2_1, b1, sizeof(Block));
    memcpy(b2_2, b2, sizeof(Block));
    hashset_add(left, b2_1);
    hashset_add(left, b2_2);
    hashset_add(left, b4);
    hashset_add(left, b5);
    ...
    hashset_destroy(right);
    free(difference_result);
    free(chunk1);
    free(chunk2);
}
...
TEST_F(HashSetTest, IntersectionTest) {
    ...
    Chunk *chunk1, *chunk2;
    Block *b1, *b2, *b3, *b4, *b5, *b1cp, *b2cp, *b4cp, *b1cp2, *b2cp2;
    ...
    b1cp2 = (Block *) malloc(sizeof(Block));
    b2cp2 = (Block *) malloc(sizeof(Block));
    ...
    hashset_create(sub_set, 16, hash_block, cmp_block, free);
    hashset_create(left, 16, hash_block, cmp_block, free);
    hashset_create(right, 16, hash_block, cmp_block, free);
    // Creating right set
    hashset_add(right, b1);
    ...
    // Creating left set
    memcpy(b1cp2, b1, sizeof(Block));
    memcpy(b2cp2, b2, sizeof(Block));
    hashset_add(left, b1cp2);
    hashset_add(left, b2cp2);
    hashset_add(left, b4);
    hashset_add(left, b5);
