...
#include "randomized_set_test.h"

void RandomizedSetTest::randomized_set_create(RandomizedSetTest::RandomizedSet *set) {
...
bool RandomizedSetTest::randomized_set_add(RandomizedSetTest::RandomizedSet  *obj, int val) {
...
bool RandomizedSetTest::randomized_set_remove(RandomizedSetTest::RandomizedSet  *obj, int val) {
    for (int i = 0; i < obj->size; i++) {
...
int RandomizedSetTest::randomized_set_get_random(RandomizedSetTest::RandomizedSet  *obj) {
...
void RandomizedSetTest::randomized_set_destroy(RandomizedSetTest::RandomizedSet  *obj) {
